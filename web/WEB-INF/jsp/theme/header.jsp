<%-- 
    Document   : header
    Created on : Jan 20, 2017, 12:32:09 PM
    Author     : awood
--%>
...
<html>
    ...
    <body class="w3-light-grey">
        ...
        <div class="w3-container w3-top w3-black w3-large w3-padding" style="z-index:4">
            ...
            <span class="w3-right">ARW CRM</span>
        </div>
        ...
        <nav class="w3-sidenav w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidenav"><br>
            <div class="w3-container w3-row">
                <div class="w3-col s4">
                    <img src="<c:url value="/media/Images/IMG_0794.jpg" />" class="w3-circle w3-margin-right" style="width:46px">
                </div>
                <div class="w3-col s8">
